...
from apptodo import urls as apptodo_urls
from django.contrib.auth import views as auth_views

urlpatterns = [
    url(r'^admin/', admin.site.urls),
    url(r'^todo/', include(apptodo_urls, namespace='apptodo')),
    url(r'^$', RedirectView.as_view(url='/todo/'), name='home'),
    # url(r'^$', include(apptodo_urls, namespace='apptodo')),
